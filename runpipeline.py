...
class vertex_ai_pipeline:
    def __init__(self,
                 ...
                 PROJECT_ID: str = "prj-n-mlmachine-learning-diso",
                 # Replace the {prod-project_id} for your prod-project-id
                 PROD_PROJECT_ID: str = "prj-p-mlmachine-learning-4n6x",
        ...
        self.deployment_config = {
            ...
            "encryption": 'projects/prj-p-kms-9j4p/locations/us-central1/keyRings/sample-keyring/cryptoKeys/prj-p-mlmachine-learning',
...
if __name__ == "__main__":
    pipeline = vertex_ai_pipeline(
        ...
        PROJECT_ID="prj-n-mlmachine-learning-diso", \
        ...
        DATAFLOW_SA="dataflow-sa@prj-n-mlmachine-learning-diso.iam.gserviceaccount.com",
    )
